...
####################################################################################
# Function to Highight only the landmarks of the active joints in the current wokout
####################################################################################
# def release_assistant(vid_path):
#     # Initialize MediaPipe pose detection
#     mp_pose = mp.solutions.pose
#     pose = mp_pose.Pose()
...
#         # Revert back to BGR for OpenCV display
...
#         # Optionally display the frame with the workout class and reps (can remove in final function)
...
#     # Return the final workout class and counters
